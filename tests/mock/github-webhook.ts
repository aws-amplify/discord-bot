export const mocked = {
  headers: {
    'X-Hub-Signature-256':
      'sha256=43c8fdfc43db7b8c986dad938e128a4cac3db2e46abf4733b5adcef0b86c0683',
  ...
  body: {
    "action": "released",
    "release": {
      "url": "https://api.github.com/repos/esauerbo1/Amplify-Bot-Testing/releases/72906088",
      "assets_url": "https://api.github.com/repos/esauerbo1/Amplify-Bot-Testing/releases/72906088/assets",
      "upload_url": "https://uploads.github.com/repos/esauerbo1/Amplify-Bot-Testing/releases/72906088/assets{?name,label}",
      "html_url": "https://github.com/esauerbo1/Amplify-Bot-Testing/releases/tag/tag2",
      "id": 72906088,
      "author": {
        "login": "esauerbo1",
        "id": 107655607,
      ...
      "node_id": "RE_kwDOHipEIc4EWHVo",
      "tag_name": "tag2",
      "target_commitish": "main",
      "name": "Another New Release!",
      "draft": false,
      "prerelease": false,
      "created_at": "2022-06-22T22:59:54Z",
      "published_at": "2022-07-26T22:38:26Z",
      "assets": [
  
      ],
      "tarball_url": "https://api.github.com/repos/esauerbo1/Amplify-Bot-Testing/tarball/tag2",
      "zipball_url": "https://api.github.com/repos/esauerbo1/Amplify-Bot-Testing/zipball/tag2",
      "body": "This is yet again a new release!\r\n\r\n\r\n"
    },
    "repository": {
      "id": 506086433,
      ...
      "pushed_at": "2022-07-26T22:38:26Z",
...
export const mockedCreated = {
  headers: {
    'X-Hub-Signature-256':
      'sha256=9e1157415fd82df847b4f076a1f2fa8b588fec41c308f19bf61209826ed4cdce',
    'content-type': 'application/json',
  },
  body: {
    action: 'created',
...
export const mockedPreReleased = {
  headers: {
    'X-Hub-Signature-256':
      'sha256=b5184eead8651e6a6f1b42a3e2e409cdf11117eff920de1741d74fca2b7f201a',
    'content-type': 'application/json',
  },
  body: {
    action: 'prereleased',
    release: {
      ...
      assets_url:
        'https://api.github.com/repos/esauerbo1/Amplify-Bot-Testing/releases/72785259/assets',
      upload_url:
        'https://uploads.github.com/repos/esauerbo1/Amplify-Bot-Testing/releases/72785259/assets{?name,label}',
      html_url:
        'https://github.com/esauerbo1/Amplify-Bot-Testing/releases/tag/newTag',
      id: 72785259,
      author: {
        login: 'esauerbo1',
        id: 107655607,
      ...
      assets: [],
      tarball_url:
        'https://api.github.com/repos/esauerbo1/Amplify-Bot-Testing/tarball/newTag',
      zipball_url:
        'https://api.github.com/repos/esauerbo1/Amplify-Bot-Testing/zipball/newTag',
...
export const mockedReleased = {
  headers: {
    'X-Hub-Signature-256':
      'sha256=a2f420351eb1b9f5d15827a150cfda80c12430e72949e378ce8e949b7296e352',
    'content-type': 'application/json',
  },
  body: {
    action: 'released',
